                        ...
                        <form id="form1" action="<?php echo site_url('admin/applyforcertificates') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="contact" value="<?php echo set_value('contact'); ?>" name="contact">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value="In Process"><?php echo $this->lang->line('in_process') ?></option>
