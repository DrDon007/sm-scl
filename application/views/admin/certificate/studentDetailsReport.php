...
<style type="text/css">
    *{padding: 0; margin:0;}
    ...
    .school-logo{float:left;width:100px;}
    .head-div{
        float:left;
    }
    .main-content
    ...
    .user-img{float:right;width:100px;margin-bottom:20px;margin-left:400px;}
    .scl-title1
    {
        /* line-height:100px; */
        margin-top:-100px;
...
$certificate_text="<div class='head-div'>
                        <img class='school-logo' src='[base_url]/uploads/school_content/admin_small_logo/1.png'>
                                            
                        <img class='user-img' src='[studentImage]'>
                        <div style='margin-bottom:280px;text-align:center;'>
                            <p class='scl-title'>BALA BHARATHI VIDYALAYAM</p>   
                        </div>
                    </div>
                    
                <div style='text-transform:capitalize;line-height:25px;float:left;margin-top:30px;'>
                    <p class='main-content-title'>Profile - </p>
                    ...
                    <p class='main-content-title'>Address -</p>
                    <table class='main-content'>
                        <tr>
                    ...
                    <p class='main-content-title'>Miscellaneous Details -</p>
                    <table class='main-content' >
                        <tr>
                            <td>Blood Group:</td>
                            <td>[blood_group]</td>
                    ...
                    <p class='main-content-title'>Parent / Guardian Details -</p>
                    <table class='main-content'>
                        <tr>
                            <td>Father Name:</td>
                            <td>[father_name]</td>
